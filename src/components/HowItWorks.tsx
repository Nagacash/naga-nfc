...
const HowItWorks: React.FC = () => {
  return (
    <section id="how" class="py-20 bg-black/50 px-4 sm:px-6"> {/* Added px-4 for mobile, sm:px-6 for larger */}
      <div class="container mx-auto"> {/* Removed px-6 here as it's now on section */}
        <div class="text-center mb-12">
          <h2 class="text-3xl md:text-4xl font-display text-white mb-4">How Our NFC Cards Boost Fan Engagement</h2>
