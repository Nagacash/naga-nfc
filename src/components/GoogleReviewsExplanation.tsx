    ...
    <section className="py-20 bg-brand-primary-base px-4 sm:px-6"> {/* Added section and padding */}
      <div className="container mx-auto text-center"> {/* Added container */}
        <div className="mb-16"> {/* Original div content */}
          <h3 className="text-2xl font-bold text-brand-secondary mb-4 text-center">Boost Your Business with Google Reviews</h3>
          ...
          <ul className="list-disc list-inside text-foreground max-w-2xl mx-auto mt-4 text-left space-y-2">
