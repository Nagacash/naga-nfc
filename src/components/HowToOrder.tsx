...
const HowToOrder: React.FC = () => {
  return (
    <section id="how-to-order" class="py-20 bg-brand-dark text-white px-4 sm:px-6">
      <div class="container mx-auto text-center">
        <h2 class="text-3xl md:text-4xl font-display text-white mb-12">How to Order Your Custom NFC Cards</h2>
        <div class="relative grid grid-cols-1 md:grid-cols-4 gap-8">
          <Step
            icon={<DesignIcon class="w-12 h-12 text-brand-red" />}
          ...
          />
          <Step
            icon={<UploadIcon class="w-12 h-12 text-brand-red" />}
          ...
          />
          <Step
            icon={<ProductionIcon class="w-12 h-12 text-brand-red" />}
            title="3. Production"
          ...
          />
          <Step
            icon={<ShippingIcon class="w-12 h-12 text-brand-red" />}
        ...
        <div class="mt-12">
          <a href="#offer" class="bg-brand-red text-white font-bold py-3 px-8 rounded-full hover:bg-brand-red-dark transition-colors duration-300">
